...
// Module represents the Instance feature module.
// It owns all components related to DatabaseInstance resource management.
type Module struct {
	handler    *Handler
...
// Config holds dependencies for the instance module.
type Config struct {
...
func NewModule(cfg Config) (*Module, error) {
	logger := cfg.Manager.GetLogger().WithName("instance")
