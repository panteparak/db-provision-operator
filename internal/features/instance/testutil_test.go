...
type MockRepository struct {
	GetInstanceFunc func(ctx context.Context, name, namespace string) (*dbopsv1alpha1.DatabaseInstance, error)
	ConnectFunc     func(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) (*ConnectResult, error)
	PingFunc        func(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) error
	GetVersionFunc  func(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) (string, error)
...
func (m *MockRepository) GetInstance(ctx context.Context, name, namespace string) (*dbopsv1alpha1.DatabaseInstance, error) {
	m.recordCall("GetInstance", name, namespace)
	return m.GetInstanceFunc(ctx, name, namespace)
}

// Connect implements RepositoryInterface.
func (m *MockRepository) Connect(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) (*ConnectResult, error) {
	m.recordCall("Connect", instance)
	return m.ConnectFunc(ctx, instance)
}

// Ping implements RepositoryInterface.
func (m *MockRepository) Ping(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) error {
	m.recordCall("Ping", instance)
	return m.PingFunc(ctx, instance)
}

// GetVersion implements RepositoryInterface.
func (m *MockRepository) GetVersion(ctx context.Context, instance *dbopsv1alpha1.DatabaseInstance) (string, error) {
