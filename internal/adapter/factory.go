...
func BuildConnectionConfig(
	...
	if spec.ClickHouse != nil {
		config.ClickHouseDialTimeout = spec.ClickHouse.DialTimeout
		config.ClickHouseReadTimeout = spec.ClickHouse.ReadTimeout
		config.ClickHouseMaxOpenConns = spec.ClickHouse.MaxOpenConns
		config.ClickHouseDebug = spec.ClickHouse.Debug
	}
