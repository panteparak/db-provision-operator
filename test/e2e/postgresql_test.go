...
var _ = Describe("postgresql", Ordered, func() {
	...
	AfterAll(func() {
		...
		deleteAndWait(ctx, databaseGrantGVR, testNamespace, "testgrant", deletionTimeout, pollingInterval)
		...
		}, deletionTimeout, pollingInterval).Should(BeTrue(), "Role, User, and Database should be deleted")
